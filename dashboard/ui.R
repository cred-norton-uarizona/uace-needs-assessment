...
navbarPage(
  ...
  tabPanel("Needs Assessment",
           ...
           tags$p("County"),
           tags$p("Urban or rural"),
           tags$p("Survey language"),
           tags$p("Educational attainment"),
           tags$p("Low-income status (185% FPL)"),
           tags$p("Gender"),
           tags$p("Age"),
           tags$p("Race/ethnicity"),
           tags$p("Topical experience"),
           tags$p("Topical knowledge"),
