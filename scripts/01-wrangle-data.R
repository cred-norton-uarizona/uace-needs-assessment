...
data <- read.csv("C:/Users/Terrace Ewinghill/Box/Cooperative Extension Needs Assessment 2022/CRED - Incubator Collaboration/scena_survey_wrangled_4.6.2023 no zip.csv")
